#WAP that has a class store which keeps the record of code and price of 
# product display the menu of all product and prompt to enter the quantity of each 
